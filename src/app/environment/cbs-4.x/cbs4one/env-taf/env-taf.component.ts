...
import { communicationServiceEnvTaf } from './env-taf.service';
...
@Component({
    selector: 'app-env-taf',
    templateUrl: './env-taf.component.html',
    styleUrls: ['./env-taf.component.css']
})
export class EnvTafComponent implements OnInit {
    ...
    url_streamAF = "http://localhost:3000/stream_AF";

    lineChart = "lineChart-taf";
    piechart = "pieChart-taf";


    constructor(private svc: CommunicationService1) { }

    ngOnInit() {
        this.getEnvName(this.url_streamAF);
...
//       //Area Chart Code
//       this.LineChart = new Chart('lineChart-taf', {
//           type: 'line',
//           data: {
//               labels: this.time_data,
//               datasets: [{
...
//       //Pie chart for Time
//       this.PieChart = new Chart('pieChart-taf', {
//           type: 'pie',
//           data: {
