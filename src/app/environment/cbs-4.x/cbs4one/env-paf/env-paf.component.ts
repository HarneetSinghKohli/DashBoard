...
import { communicationServiceEnvPaf } from './env-paf.service';
...
@Component({
    selector: 'app-env-paf',
    templateUrl: './env-paf.component.html',
    styleUrls: ['./env-paf.component.css']
})
export class EnvPafComponent implements OnInit {
    ...
    lineChart = "lineChart-paf";
    piechart = "pieChart-paf";
...
//         //Area Chart Code
//         this.LineChart = new Chart('lineChart-paf', {
//             type: 'line',
//             data: {
//                 labels: this.time_data,
//                 datasets: [{
...
//         //Pie chart for Time
//         this.PieChart = new Chart('pieChart-paf', {
//             type: 'pie',
//             data: {
