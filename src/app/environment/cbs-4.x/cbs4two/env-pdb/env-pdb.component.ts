...
import { communicationServiceEnvPdb } from './env-pdb.service';
...
@Component({
    selector: 'app-env-pdb',
    templateUrl: './env-pdb.component.html',
    styleUrls: ['./env-pdb.component.css']
})
export class EnvPdbComponent implements OnInit {
    ...
    lineChart = "lineChart-pdb";
    piechart = "pieChart-pdb";
...
//       //Area Chart Code
//       this.LineChart = new Chart('lineChart-pdb', {
//           type: 'line',
//           data: {
//               labels: this.time_data,
//               datasets: [{
...
//       //Pie chart for Time
//       this.PieChart = new Chart('pieChart-pdb', {
//           type: 'pie',
//           data: {
