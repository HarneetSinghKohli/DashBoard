...
import { communicationServiceEnvTdb } from './env-tdb.service';
...
@Component({
    selector: 'app-env-tdb',
    templateUrl: './env-tdb.component.html',
    styleUrls: ['./env-tdb.component.css']
})
export class EnvTdbComponent implements OnInit {
    ...
    lineChart = "lineChart-tdb";
    piechart = "pieChart-tdb";
...
//         //Area Chart Code
//         this.LineChart = new Chart('lineChart-tdb', {
//             type: 'line',
//             data: {
//                 labels: this.time_data,
//                 datasets: [{
...
//         //Pie chart for Time
//         this.PieChart = new Chart('pieChart-tdb', {
//             type: 'pie',
//             data: {
