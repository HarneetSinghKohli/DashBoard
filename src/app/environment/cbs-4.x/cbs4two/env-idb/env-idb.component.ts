...
import { communicationServiceEnvIdb } from './env-idb.service';
...
@Component({
    selector: 'app-env-idb',
    templateUrl: './env-idb.component.html',
    styleUrls: ['./env-idb.component.css'],
    providers: [communicationServiceEnvIdb]
})
export class EnvIdbComponent implements OnInit {
    ...
    url_stream_DB = "http://localhost:3000/stream_DB";

    lineChart = "lineChart-idb";
    piechart = "pieChart-idb";


    constructor(private svc: CommunicationService1) { }

    ngOnInit() {
        this.getEnvName(this.url_stream_DB);
...
//         //Area Chart Code
//         this.LineChart = new Chart('lineChart-idb', {
//             type: 'line',
//             data: {
//                 labels: this.time_data,
//                 datasets: [{
...
//         //Pie chart for Time
//         this.PieChart = new Chart('pieChart-idb', {
//             type: 'pie',
//             data: {
