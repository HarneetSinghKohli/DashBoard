...
import { communicationServiceEnvTm3 } from './env-tm3.service';
...
@Component({
    selector: 'app-env-tm3',
    templateUrl: './env-tm3.component.html',
    styleUrls: ['./env-tm3.component.css']
})
export class EnvTm3Component implements OnInit {
    ...
    lineChart = "lineChart-tm3";
    piechart = "pieChart-tm3";
...
// //Area Chart Code
// this.LineChart = new Chart('lineChart-tm3', {
//     type: 'line',
//     data: {
//         labels: this.time_data,
//         datasets: [{
...
// //Pie chart for Time
// this.PieChart = new Chart('pieChart-tm3', {
//     type: 'pie',
//     data: {
