...
import {communicationServiceEnvPm3 } from './env-pm3.service';

import { Chart } from 'chart.js';
@Component({
  selector: 'app-env-pm3',
  templateUrl: './env-pm3.component.html',
  styleUrls: ['./env-pm3.component.css']
})
export class EnvPm3Component implements OnInit {
  ...
  constructor(private svc: communicationServiceEnvPm3) { }
  ...
  ngOnInit() {
    ...
    this.svc.getCommunicationData().subscribe(commData =>{
      ...
      //Area Chart Code
      this.LineChart = new Chart('lineChart-pm3', {
          type: 'line',
          data: {
      ...
      //Pie chart for Time
      this.PieChart = new Chart('pieChart-pm3', {
          type: 'pie',
          data: {
